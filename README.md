...
- [`relay/`](relay/README.md) — an open-source relay on a Cloudflare Worker with KV. It fans events out to paired iPhones over APNs and stores devices under a hash of the install key, never the key or any plaintext. Self-hostable; Uzair runs the default instance.
